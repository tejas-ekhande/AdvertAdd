        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                <div class="banner-content content-padding">
                    ...
                    <p>"The formula that Mabbly uses is actually fairly simple.They have this fantastic creative platform multiplied by some really smart,talented,passionate people.It has enabled us to do things that you just dont find on the market."</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-12 col-md-8 mb-4">
                    ...
                    <a href="contact.php" class="mt-3 d-inline-block">Learn more about us <i class="fa fa-angle-right"></i></a>
                </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="text-center border p-4 rounded mb-4">
                    <span class="counter  text-dark font-weight-normal">103</span>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="text-center border p-4 rounded mb-4">
                    <span class="counter text-dark font-weight-normal">29</span>
                    <h5 class="text-uppercase mt-2">Experienced stuff</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="text-center border p-4 rounded ">
                    <span class="counter text-dark font-weight-normal">7</span>
...
<div class="col-lg-12 text-right">
    <div class="footer-copy">
        Designed by <a href="https://https://www.instagram.com/__tejas_01/">Programming Solution</a> 
    </div>
</div>
    <!-- 
    Essential Scripts
